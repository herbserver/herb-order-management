...
files.forEach(file => {
    if (fs.existsSync(file)) {
        ...
        content = content.replace(/js\/panels\/employee\.js\?v=[^"']+/g, 'js/panels/employee.js?v=' + timestamp);
        content = content.replace(/js\/panels\/employee\/shared\/order-form\.js\?v=[^"']+/g, 'js/panels/employee/shared/order-form.js?v=' + timestamp);
