...
async function exportAllOrders() {
    try {
        ...
        XLSX.writeFile(wb, fileName); // Keep this line for actual download
        if (document.getElementById('adminMessage')) showMessage('Orders Exported Successfully! ✅', 'success', 'adminMessage');
