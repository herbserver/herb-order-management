            ...
            html += `<div class="order-card bg-white border rounded-xl p-4 border-l-4 border-l-green-500">
                        <div class="flex justify-between items-start">
                            <div>
                                ...
                                <p class="text-sm text-gray-500 font-mono bg-green-50 inline-block px-2 py-1 rounded">📞 ${order.telNo}</p>
                            </div>
                        ...
                        <div class="mt-3">
                            <button type="button" onclick="viewOrder('${order.orderId}')" class="bg-indigo-500 text-white px-3 py-1.5 rounded-lg text-xs">👁️ View</button>
                        </div>
                    </div>`;
        });
