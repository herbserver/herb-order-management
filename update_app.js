...
const target1 = `        // Populate Items manually as they no longer have per-row Amount
...
const replacement1 = `        // Populate Items using addItem to ensure compatibility with employee.js
        const container = document.getElementById('itemsContainer');
        container.innerHTML = '';
        (order.items || []).forEach(item => {
...
if (content.includes(target1)) {
    ...
    console.log("SUCCESS editOrder");
} else {
    console.log("TARGET NOT FOUND editOrder");
}

const target2 = `            itemsHtml += \`
...
const replacement2 = `            let descOptions = '<option value="">Select Product...</option>';
...
if (content.includes(target2)) {
    ...
    console.log("SUCCESS openEditOrderModal");
} else {
    console.log("TARGET NOT FOUND openEditOrderModal");
}

const target3 = `    div.innerHTML = \` 
...
const replacement3 = `    let descOptions = '<option value="">Select Product...</option>';
    if (typeof PRODUCT_LIST !== 'undefined' && Array.isArray(PRODUCT_LIST)) {
        PRODUCT_LIST.forEach(p => {
...
if (content.includes(target3)) {
    ...
    console.log("SUCCESS addEditItem");
} else {
    console.log("TARGET NOT FOUND addEditItem");
}

const target4 = `function updateEditItemAmount(input) {
...
const replacement4 = `function updateEditItemAmount(input) {
    const row = input.closest('.edit-item-row');
...
if (content.includes(target4)) {
    ...
    console.log("SUCCESS updateEditItemAmount");
} else {
    console.log("TARGET NOT FOUND updateEditItemAmount");
}
